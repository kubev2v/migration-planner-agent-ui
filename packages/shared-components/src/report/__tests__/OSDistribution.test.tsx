...
import { OSBarChart, OSDistribution } from "../OSDistribution.js";
import { SUPPORT_TIER_DEFINITIONS, SupportTier } from "../osSupportTier.js";
...
const sampleOsData = {
  ...
  "Ubuntu Linux 22.04 (64-bit)": {
    count: 3,
    supported: true,
    supportTier: SupportTier.VendorSupported,
    upgradeRecommendation: "",
  },
  "CentOS 7 (64-bit)": {
    count: 2,
...
describe("OSBarChart", () => {
  ...
  it("shows official Red Hat definitions in tier badge tooltips", async () => {
    ...
    expect(
      await screen.findByText(SUPPORT_TIER_DEFINITIONS[SupportTier.Certified]),
    ).toBeInTheDocument();
  });
